...
**These docs are also too big to read whole.** Together they are ~118,000
...
| `docs/SECURITY.md` | ~8,000 | touching auth, session tokens, rate limits, the CSP, or any user-controlled output - it ends with a pre-merge checklist | `grep -n '^## '` (18 headings) |
