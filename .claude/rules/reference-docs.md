...
**These docs are also too big to read whole.** Together they are ~110,000
...
That turns a 23,000-token read into roughly 1,000. Use it by default; read a
...
| `docs/JAVASCRIPT.md` | ~23,000 | adding or refactoring a frontend ES module | `grep -n '^### ' docs/JAVASCRIPT.md` (84 module sections) |
...
| `docs/TESTING.md` | ~13,500 | writing tests, or checking whether something is actually covered | `grep -n '^#\{2,3\} '` (14 headings) |
