...
**These docs are also too big to read whole.** Together they are ~105,000
...
| `docs/JAVASCRIPT.md` | ~21,500 | adding or refactoring a frontend ES module | `grep -n '^### ' docs/JAVASCRIPT.md` (78 module sections) |
| `docs/FRONTEND.md` | ~14,500 | touching `index.html`, the CSS, the service worker, the fonts, or the build | `grep -n '^#\{2,3\} '` (22 headings) |
