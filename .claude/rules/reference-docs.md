...
**These docs are also too big to read whole.** Together they are ~122,500
...
| `docs/TESTING.md` | ~17,000 | writing tests, or checking whether something is actually covered | `grep -n '^#\{2,3\} '` (14 headings) |
