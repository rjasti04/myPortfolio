...
**These docs are also too big to read whole.** Together they are ~119,500
...
| `docs/TESTING.md` | ~15,500 | writing tests, or checking whether something is actually covered | `grep -n '^#\{2,3\} '` (14 headings) |
