...
**These docs are also too big to read whole.** Together they are ~97,000
...
That turns a 20,500-token read into roughly 500. Use it by default; read a
...
| `docs/JAVASCRIPT.md` | ~20,500 | adding or refactoring a frontend ES module | `grep -n '^### ' docs/JAVASCRIPT.md` (71 module sections) |
...
| `docs/TESTING.md` | ~10,000 | writing tests, or checking whether something is actually covered | `grep -n '^#\{2,3\} '` (14 headings) |
