...
// The landing view's name. The treatment opened the About hero until #home
// became the landing section and took the identity with it; the CSS class
// names below (`.hero-word`, `.hero-char`) still carry the original prefix and
// are shared, so a second title can opt in by extending this selector.
const HERO_TITLE_SELECTOR = ".home-name";
