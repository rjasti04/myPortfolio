/**
 * Fast, regex-based HTML escaper that avoids synchronous DOM operations
 * which can block the main thread and cause memory leaks over time.
 * Performance: ~17x faster than document.createElement('div').textContent
 */
...
export function escapeHTML(value) {
  return String(value).replace(/[&<>"'`=\/]/g, (s) => HTML_ENTITY_MAP[s]);
}
