export function escapeHTML(value) {
  // Use regex-based string manipulation instead of DOM manipulation (textContent to innerHTML).
  // DOM manipulation fails to escape quotes, leading to potential attribute injection XSS vulnerabilities.
  return String(value)
    .replace(/&/g, "&amp;")
    .replace(/</g, "&lt;")
    .replace(/>/g, "&gt;")
